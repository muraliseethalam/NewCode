...
public class Client_Zoom_Mediation_Session_Mail_Validation_PageObjects {
	
	public static Logger logger;
	WebDriver driver;
	public static String sessionID;
	public static String link;
	public Client_Zoom_Mediation_Session_Mail_Validation_PageObjects(WebDriver driver) {
		this.driver=driver;
			...
			SearchTerm searchCondition = new SearchTerm() {
				...
				public boolean match(Message message) {
				    try {
				        ...
				        if (subject.contains("Deposition Of MAT Mediation Session Zoom") || 
				            subject.contains("Session Of MAT Mediation Session Zoom")) {
...
//						obj.WriteExcel("Sheet1", link, 13, 1);
	...
	public void ClickOnArbitrationSessionLink() throws Exception {
		driver.get(link);
		logger.info("Printed mediation session link");
