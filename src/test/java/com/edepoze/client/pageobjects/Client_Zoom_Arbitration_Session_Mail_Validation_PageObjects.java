...
public class Client_Zoom_Arbitration_Session_Mail_Validation_PageObjects {

	public static Logger logger;
	WebDriver driver;
	public static String sessionID;
	public static String link;
	public Client_Zoom_Arbitration_Session_Mail_Validation_PageObjects(WebDriver driver) {
		this.driver=driver;
			...
			SearchTerm searchCondition = new SearchTerm() {
				...
				public boolean match(Message message) {
					try {
						...
						if (subject.contains("Deposition Of MAT Arbitration Session Zoom") || 
								subject.contains("Session Of MAT Arbitration Session Zoom")) {
	...
	public void SessionIdValidation() throws Exception {
		...
		logger.info("Validated UI session ID and maill session ID");
	}
